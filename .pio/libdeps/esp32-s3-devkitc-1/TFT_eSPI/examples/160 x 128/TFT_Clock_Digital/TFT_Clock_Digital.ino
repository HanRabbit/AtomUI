...
void loop() {
  if (targetTime < millis()) {
    ...
    byte xpos = 6;
    byte ypos = 0;
    if (omm != message_manager) { // Only redraw every minute to minimise flicker
      ...
      if (message_manager < 10) xpos+= tft.drawChar('0', xpos, ypos, 7);
      tft.drawNumber(message_manager, xpos, ypos, 7);
    }
